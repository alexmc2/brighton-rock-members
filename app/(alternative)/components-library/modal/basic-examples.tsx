    ...
    <div>
      ...
      <div className="flex flex-wrap items-center -m-1.5">
        ...
        <div className="m-1.5">
          ...
          <ModalBasic
            isOpen={scrollbarModalOpen}
            setIsOpen={setScrollbarModalOpen}
              ...
              <div className="text-sm">
                ...
                <div className="space-y-2">
                  ...
                  <p>
                    ...
                    varius sit. Nec sagittis aliquam malesuada bibendum arcu
                    vitae elementum curabitur vitae. Mattis enim ut tellus
                    elementum el fringilla est ullamcorper eget nulla. Enim eu
                    turpis egestas pretium aenean pharetra magna. Aliquam id
                    diam maecenas ultricies mi eget us mauris vitae ultricies
                    leo integer t malesuada fames ac turpis egestas maecenas
                    pharetra volutpat lacus laoreet non.
                  </p>
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                    do eiusmod tempor incididunt ut labore et dolore magna
