      ...
      <div className="flex flex-wrap items-center -m-1.5">
          ...
          >
            ...
            <div className="text-center">
              ...
              <form className="flex max-w-sm m-auto">
                ...
                <button
                  type="submit"
                  className="btn-sm bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white whitespace-nowrap"
                >
                  Subscribe
                </button>
              </form>
        ...
        <div className="m-1.5">
          ...
          <ModalAction
            ...
            setIsOpen={setAnnouncementModalOpen}
          >
            {/* Modal header */}
            <div className="mb-2 text-center">
              {/* Icon */}
        ...
        <div className="m-1.5">
          ...
          <ModalAction
            ...
            setIsOpen={setIntegrationModalOpen}
          >
            {/* Modal header */}
            <div className="mb-5 text-center">
              ...
              <div className="inline-flex items-center justify-center space-x-3 mb-4">
                ...
                <svg width="48" height="48" viewBox="0 0 48 48">
                  <rect
                    className="fill-gray-100 dark:fill-violet-500/30"
                    width="48"
                    height="48"
                    rx="24"
                  />
            ...
            <div className="p-5">
              ...
              <div className="text-sm mb-5">
                <div className="space-y-2">
                  <p>
                    You might not be aware of this fact, but every frame,
                    digital video, canvas, responsive design, and image often
                    has a rectangular shape that is exceptionally precise in
                    proportion (or ratio).
                  </p>
                  <p>
                    The ratio has to be well-defined to make shapes fit into
                    different and distinct mediums, such as computer, movies,
