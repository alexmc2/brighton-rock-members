...
// import { updateSocialEvent } from '@/lib/actions/social-events';
...
//       // Update the social event using the server action
//       const updatedEvent = await updateSocialEvent(event.id, data);
...
//       // Create new calendar event if date is set
//       if (eventDate) {
