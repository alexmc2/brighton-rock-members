      ...
      <div className="flex flex-col h-full">
        ...
        <div className="border-t border-gray-100 dark:border-gray-700/60">
          <div className="flex divide-x divide-gray-100 dark:divide-gray-700/60">
            <Link
              className="block flex-1 text-center text-sm text-violet-500 hover:text-violet-600 dark:hover:text-violet-400 font-medium px-3 py-4"
              href="/messages"
            >
            ...
            >
              <div className="flex items-center justify-center">
                <svg
                  className="fill-current text-gray-400 dark:text-gray-600 group-hover:text-gray-500 shrink-0 mr-2"
                  width="16"
                  height="16"
                  viewBox="0 0 16 16"
                >
