...
export type CommentResourceType = 
  | { type: 'development'; field: 'initiative_id'; contentField: 'content'; userField: 'user_id' }
  | { type: 'garden'; field: 'task_id'; contentField: 'comment'; userField: 'user_id' }
  | { type: 'maintenance'; field: 'request_id'; contentField: 'comment'; userField: 'user_id' }
  | { type: 'task'; field: 'task_id'; contentField: 'content'; userField: 'created_by' };
