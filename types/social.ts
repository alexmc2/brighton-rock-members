...
// // Define the payload for real-time changes
// export interface SocialEventParticipantPayload {
//   event_id: string;
//   user_id: string;
//   status: ParticipationStatus;
...
// // Update the RealtimePostgresChangesPayload type
// export interface RealtimePayload {
//   eventType: 'INSERT' | 'UPDATE' | 'DELETE';
//   schema: string;
//   table: string;
//   // For INSERT and UPDATE events, new is SocialEventParticipantPayload
//   new: SocialEventParticipantPayload | null;
//   // For UPDATE and DELETE events, old is SocialEventParticipantPayload
//   old: SocialEventParticipantPayload | null;
// }
